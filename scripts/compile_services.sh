...
SERVICES_ORDER=("COMMON" "AUTH-SERVICE" "GATEWAY_DIR" "EUREKA_DIR" "QUESTION-SERVICE" "TEST-TAKING-SERVICE" "TEST-CREATE-SERVICE" "RESULTS-SERVICE")
# "PROCT-SERVICE" "TEST-EVAL-SERVICE"
