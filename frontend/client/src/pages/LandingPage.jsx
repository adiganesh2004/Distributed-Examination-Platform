      ...
      <div className="grid gap-6 md:grid-cols-2 w-full max-w-3xl">
        <Card className="p-8 flex flex-col items-center space-y-4 bg-white shadow-xl">
          ...
          <Link to="/candidate-login" className="w-full">
            <Button className="w-full bg-blue-600 hover:bg-blue-700">Candidate Login</Button>
          </Link>
        </Card>
        ...
        <Card className="p-8 flex flex-col items-center space-y-4 bg-white shadow-xl">
          ...
          <Link to="/admin-login" className="w-full">
            <Button className="w-full bg-indigo-600 hover:bg-indigo-700">Admin Login</Button>
          </Link>
        </Card>
      </div>
    </div>
